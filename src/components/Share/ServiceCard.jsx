...
const ServiceCard = ({ service }) => {
    return (
        <div className="px-6 bg-zinc-950 hover:bg-zinc-900 hover:shadow-[#f34e3a] hover:shadow-lg h-[600px]" data-aos="zoom-in">
            ...
            <div className="flex flex-col gap-6 mt-6">
                <div className="flex items-center justify-between">
                    <h1 className="text-2xl font-semibold sm:text-xl lg:">{service.title}</h1>
