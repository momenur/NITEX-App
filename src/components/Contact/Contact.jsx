...
const Contact = () => {
    return (
        <section id="contact" className="pb-20 border-b-[1px] border-b-gray-100">
            <Title title="Contract Us" description="Stay In Our Touch" />
                                    ...
                                    <div className="flex flex-col gap-6 py-2">
                                        <div className="flex flex-col gap-10 lgl:flex-row">
                                            <div className="flex flex-col w-full gap-4 lgl:w-1/2">
                                                ...
                                                <input className="py-2 focus:outline-none ps-4 focus:border-[#f34e3a] focus:border-2" type="text" name="to_name" id="" />
                                            </div>
                                            <div className="flex flex-col w-full gap-4 lgl:w-1/2">
                                                <p className="text-sm tracking-wide text-gray-400 uppercase">Phone Number</p>
                                                <input className="py-2 focus:outline-none ps-4 focus:border-[#f34e3a] focus:border-2" type="text" name="" id="" />
                                            </div>
                                        </div>
                                        <div className="flex flex-col w-full gap-4">
                                            <p className="text-sm tracking-wide text-gray-400 uppercase">your email</p>
                                            <input className="py-2 focus:outline-none ps-4 focus:border-[#f34e3a] focus:border-2" type="email" name="from_name" id="" />
                                        </div>
                                        <div className="flex flex-col w-full gap-4">
                                        ...
                                        <div className="flex flex-col w-full gap-4">
                                            ...
                                            <textarea className="focus:outline-none ps-4 focus:border-[#f34e3a] focus:border-2" name="message" cols="30" rows="5"></textarea>
                                        </div>
                                        <div>
