...
const Navbar = () => {
    ...
    return (
        <div className="flex sticky top-0 z-50 items-center justify-between w-full h-20 border-b-[1px] border-b-gray-100">
            ...
            <div>
                <ul className="items-center hidden gap-6 lg:gap-10 md:inline-flex">
                    {
