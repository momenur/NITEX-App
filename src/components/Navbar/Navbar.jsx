    ...
    return (
        <nav className="sticky top-0 z-50 flex items-center justify-between w-full h-20 text-lg font-bold bg-[#111111] pe-6">
            ...
            <div className="bg-red">
                <ul className="items-center hidden gap-6 navItems lg:gap-10 lg:inline-flex">
                    {
                ...
                <span
                    ...
                    className="inline-flex items-center justify-center w-10 h-10 text-xl text-[#f34e3a] bg-transparent rounded-full cursor-pointer lg:hidden"
                ><FiMenu></FiMenu></span>
                {showMenu && (
